...
<head>
    ...
    <title>OLAP DWO AdventureWorks</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h4>OLAP DWO ADVENTURE WORKS</h4>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                include 'koneksi.php';
                                                $result = mysqli_query($conn, "SELECT SUM(`Quantity`) AS total FROM factproductinventory");
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Total Purchase Quantity</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                include 'koneksi.php';
                                                $result = mysqli_query($conn, "SELECT SUM(`orderqty`) AS total FROM factproductvendor");
                                                $row = mysqli_fetch_assoc($result);
                                                echo '' . number_format($row['total']);
                                                ?>
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                // include 'koneksi.php';
                                                // $result = mysqli_query($conn, "SELECT SUM(`unitprice`) AS total FROM factproductvendor");
                                                // $row = mysqli_fetch_assoc($result);
                                                // echo '' . number_format($row['total']);
                                                ?>
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                include 'koneksi.php';
                                                $result = mysqli_query($conn, "SELECT COUNT(DISTINCT VendorID) AS total FROM factproductvendor;");
                                                $row = mysqli_fetch_assoc($result);
                                                echo '' . number_format($row['total']);
                                                ?>
                                            </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Category Product</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                                                                include 'koneksi.php';
                                                                                                $result = mysqli_query($conn, "SELECT COUNT(DISTINCT ProductCategory) AS total FROM product");
                                                                                                $row = mysqli_fetch_assoc($result);
                                                                                                echo '' . number_format($row['total']);
                                                                                                ?>
                                            </div>
                                    ...
                                    <div class="card-body ">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2 mx-auto">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    <iframe name="mondrian" src="http://localhost:8080/olapdwo/" style="height:300px; width:100%; border:none; align-content:center">
                                                    </iframe>
                                                </div>
                                            </div>
                                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kelompok 4 | MK Data Warehouse 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
