...
<!-- <li><a href="testpage.jsp?query=whawFactS">OLAP Adventure Works Fact Vendor </a></li> -->
<li><a href="testpage.jsp?query=whawPur">OLAP Adventure Works Fact Vendor </a></li>
</ul>
